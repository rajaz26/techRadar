...
const EmailInbox = () => {
  document.title = "Inbox | Dashonic - React Admin & Dashboard Template";
  return (
    <React.Fragment>
                  ...
                  <ul className="message-list">
                    <li>
                      <div className="col-mail col-mail-1">
                        ...
                        <span className="star-toggle text-warning bx bxs-star" />
                      </div>
                    ...
                    <li>
                      <div className="col-mail col-mail-1">
                        ...
                        <span className="star-toggle bx bx-star" />
                      </div>
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-soft-info me-1">Support</span>{" "}
                          Off on Thursday -{" "}
                          <span className="teaser">
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-soft-primary me-2">Social</span>
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-soft-success me-2">Family</span>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          ...
                          <span className="teaser">
                            ...
                            class of the inbox. For your records, here is a
                    ...
                    <li>
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-soft-danger me-2">Friends</span>
                          Weekend on Revibe – {" "}
                          <span className="teaser">
                    ...
                    <li className="unread">
                      ...
                      <div className="col-mail col-mail-2">
                        <Link to="#" className="subject">
                          <span className="badge badge-soft-info me-2">Support</span>
                          Home again! – {" "}{" "}
                          <span className="teaser">
