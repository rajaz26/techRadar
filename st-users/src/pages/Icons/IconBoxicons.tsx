...
const IconDripicons = () => {
  document.title = "Boxicons | Dashonic - React Admin & Dashboard Template";
  return (
    <React.Fragment>
            ...
            <Col xs="12">
              <Card>
                <CardHeader className="justify-content-between d-flex align-items-center">
                  ...
                  <Link to="//boxicons.com/" target="_blank" rel="noreferrer" className="btn btn-sm btn-soft-secondary">Docs <i className="mdi mdi-arrow-right align-middle"></i></Link>
                </CardHeader>
                <CardBody>
                  <h5>Regular</h5>
