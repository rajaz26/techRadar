...
const IconMaterialdesign = () => {
  document.title = "Material Design | Dashonic - React Admin & Dashboard Template";
  useEffect(() => {
    function isNew(icon: any) {
      return icon.version === "5.0.45";
    }

    function getIconItem(icon: any) {
    ...
    (function () {
      ...
      icons.forEach(function (icon: any) {
        ...
        let iconsItem: any = document.getElementById("icons");
        iconsItem.appendChild(item);
        if (isNew(icon)) {
          const newItem = getIconItem(icon);
          let newiconsItem: any = document.getElementById("newIcons");
          newiconsItem.appendChild(newItem);
        }
      });
    })();
  });
